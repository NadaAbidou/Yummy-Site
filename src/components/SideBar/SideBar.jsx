...
export default function SideBar() {
 ...
 function changeStatus() {
  let position = window.getComputedStyle(sidebar.current).getPropertyValue("left"); 
     ...
     <nav ref={sidebar} className={`${style["main-nav"]} position-fixed`}>
        <div ref={innerSideBar} className="d-flex flex-column justify-content-between p-3">
          <ul className="list-unstyled">
            ...
            <li className="p-0 mb-1">
              <NavLink  to="/search" className="w-100 d-inline-block p-2" onClick={closeSidebar}> Search </NavLink>
            </li>
           
            <li className="p-0 mb-1">
              <NavLink to="/categories" className="w-100 d-inline-block p-2" onClick={closeSidebar} >Categories</NavLink>
            </li>
          
            <li className="p-0 mb-1">
              <NavLink to="/area" className="w-100 d-inline-block p-2" onClick={closeSidebar} > Area </NavLink>
            </li>
           
            <li className="p-0 mb-1">
              <NavLink to="/ingredients" className="w-100 d-inline-block p-2" onClick={closeSidebar}>Ingredients</NavLink>
            </li>
          
            <li className="p-0 mb-1">
               <NavLink to="/contact" className="w-100 d-inline-block p-2" onClick={closeSidebar} > Contact Us </NavLink>
            </li>
        ...
        <div className="text-black px-2 py-3 d-flex flex-column justify-content-between align-items-center">
          ...
          <NavLink className="logo" to="/" onClick={closeSidebar}>
            <img src={logo} className={`${style.logo} pointer`} alt="Yummy Logo"  />
          </NavLink>
         
          <i className="fa-solid fa-bars fa-2x pointer" onClick={changeStatus} ref={menuIcon} ></i>
